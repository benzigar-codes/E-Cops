...
if (isset($_POST['subject'])) {
    ...
    $id = mysqli_query($connection, "select id from users where email='$email';");
    ...
    mysqli_query($connection, "insert into complaint values(NULL,$userid,'$subject','$location','$date','$description','Police Unseen',' ');");
    $result = mysqli_query($connection, "select id from complaint where userid=$userid order by id desc;");
    $result = mysqli_fetch_all($result);
    $complaintid = $result[0][0];
    ?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        ...
        <title>Successfully Registered Complaint</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p class="lead">Your ID is <?php echo $complaintid; ?></p>
            <a href="complaint.php?id=<?php echo $complaintid; ?>">
