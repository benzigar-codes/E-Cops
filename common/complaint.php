            ...
            <body>
                ...
                <div class="container mt-4">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <h1>Compliant Status</h1>
                            <table class="table">
                                <tr>
                                    <td>
                                        <?php
                                                    if ($compliantstatus == 'Police Unseen') {
                                                        echo "Police have not yet seen the message";
                                                    }
                                                    if ($compliantstatus == 'Closed') {
                                                        echo "This Comliant is closed !";
                                                    }
                                                    if ($compliantstatus == 'Police Seen' && $compliantpolice_msg == ' ') {
                                                        echo "Police seen the compliant and will reply you soon";
                                                    }
                                                    if ($compliantstatus == 'Police Seen' && $compliantpolice_msg != ' ') {
                                                        echo "Police seen the compliant and this is the reply for your compliant";
                                                    }
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <?php
                                                    if ($compliantstatus == 'Police Seen' && $compliantpolice_msg != ' ') {
                                                        echo '<div class="card p-4 border">';
                                                        echo "<h5>" . $compliantpolice_msg . "</h5>";
                                                        echo "</div>";
                                                    }
                                                    ?>
