            ...
            <div class="container mt-4">
                <div class="row">
                    <div class="col-4">
                        ...
                        <form action="">
                            <h3>Give a reply</h3>
                            <input type="hidden" name="id" value="<?php echo $compliantid; ?>">
                            <textarea name="reply" id="" class="form-control mb-3" cols="30" rows="4"></textarea>
                            <input type="submit" value="Submit" class="btn btn-primary btn-block">
                        </form>
                    </div>
                    <div class="col-8">
                        <h1 class="mb-4">Volenteers : </h1>
                        <?php
                                $result = mysqli_query($connection, "select name,message from volunteers_msg where complaintid=$compliantid;");
