...
if (isset($_SESSION['username'])) {
    if (isset($_GET['id'])) {
        if (isset($_GET['msg'])) {
            ...
            $msg = $_GET['msg'];
            mysqli_query($connection, "INSERT INTO `volunteers_msg` (`id`, `complaintid`, `name`, `message`) VALUES (NULL, '$id', '$username', '$msg');");
        }
        $id = $_GET['id'];
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div>
                                <?php
                                            $username = $_SESSION['username'];
                                            $result = mysqli_query($connection, "select name,message from volunteers_msg where complaintid=$compliantid and name='$username';");
                                            if (mysqli_num_rows($result)) {
                                                echo '
                                                <h1 class="mb-4">Your Previous Messages : </h1>';
                                            }
                            ...
                            <form action="complaint.php" class="mt-2" method="get">
                                <input type="hidden" name="id" value="<?php echo $id; ?>">
                                <textarea required class="form-control" name="msg" id="" cols="30" rows="10"></textarea>
